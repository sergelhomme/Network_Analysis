...
class Ui_Dialogtool2(object):
    def setupUi(self, Dialog):
        ...
        self.comboBox.setGeometry(QtCore.QRect(150, 30, 121, 22))
        ...
        self.label2.setGeometry(QtCore.QRect(30, 92, 121, 16))
        self.label2.setFont(font)
        self.label2.setObjectName("label_2")
        self.comboBox2 = QtWidgets.QComboBox(Dialog)
        self.comboBox2.setGeometry(QtCore.QRect(150, 90, 121, 22))
