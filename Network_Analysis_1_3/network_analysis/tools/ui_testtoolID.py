...
class Ui_DialogtesttoolID(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QtGui.QApplication.translate("Dialog", "Nodes ID", None, QtGui.QApplication.UnicodeUTF8))
        self.label2.setText(QtGui.QApplication.translate("Dialog", "Edges Start ID", None, QtGui.QApplication.UnicodeUTF8))
        self.label3.setText(QtGui.QApplication.translate("Dialog", "Edges End ID", None, QtGui.QApplication.UnicodeUTF8))
